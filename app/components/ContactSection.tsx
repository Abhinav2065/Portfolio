...
export default function ContactSection() {
				...
				<div className="max-w-4xl mx-auto">
					...
					>
						...
						<div className="relative z-10">
							<div className="absolute flex items-center top-0 right-4 gap-2 mb-6">
	...
	×
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:abhinavsl511@gmail.com"
							...
							>
									abhinavsl511@gmail.com							</motion.a>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@Abhinav2065</p>
									</div>
								</motion.a>
								<motion.a
									href="#"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Abhinav Siluwal</p>
									</div>
								</motion.a>
								{/* <motion.a
									href="#"
